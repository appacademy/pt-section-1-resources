...
function shoppingList(list) {
  // shoppingList returns a function
  function inner(string) { // return (string) => {...} => ALSO WORKS
    // inner/return function should take in a string to add to the list
    list.push(string); // careful, push returns the length of the array!!!
    // returning the mutated list
    return list;
  };
  return inner;
}
