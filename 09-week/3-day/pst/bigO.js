...
animals1 = ['alligator'];
animals2 = ['alligator', 'bear'];
animals3 = ['alligator', 'bear', 'cat'];
animals.push("greg");
animals1.push("greg");
...
console.log(getAnimalTriples(animals1));
console.log(getAnimalTriples(animals2));
console.log(getAnimalTriples(animals3));
