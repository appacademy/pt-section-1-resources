document.addEventListener("DOMContentLoaded", () => {
    ...
    const luffy = document.getElementById("luffy-img");
    console.log(luffy.getAttribute("src"));
    ...
    const featured = document.querySelectorAll(".featured-article");
    featured.forEach(el => el.removeAttribute("style"));
