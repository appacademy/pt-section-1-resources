...
- A two-dimensional layout system to create a `grid` with columns and rows in `CSS`.
- Allows you to control the entire page layout
- can add as many columns and rows as you want

<img src='https://raw.githubusercontent.com/appacademy/SWEO-Part-Time-Resources/2022-May-W/3-Module/2-week/3-day/lecture/pics/gridlayout.png' width='500'>
...
<img src='https://raw.githubusercontent.com/appacademy/SWEO-Part-Time-Resources/2022-May-W/3-Module/2-week/3-day/lecture/pics/gridexample.png' width='500'>
...
<img src='https://raw.githubusercontent.com/appacademy/SWEO-Part-Time-Resources/2022-May-W/3-Module/2-week/3-day/lecture/pics/gridtemplateareas.png' width='500'>
...
- uses `row-gap` and `column-gap` or the shorthand `gap` and accepts a size value
- These properties used to be called `grid-row-gap`, `grid-column-gap`, and `grid-gap` so you may see that in older CSS.
...
<img src='https://raw.githubusercontent.com/appacademy/SWEO-Part-Time-Resources/2022-May-W/3-Module/2-week/3-day/lecture/pics/gridgap.png' width='500'>
