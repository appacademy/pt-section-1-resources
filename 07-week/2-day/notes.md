...
- Basically this means your functions should _do one thing and do it well_, if they are doing too many things you should refactor and break that function up into helper functions.
...
- Check your code for _patterns_ that come up at least twice. If you find them, you can refactor your code by possibly adding that code to it's own function or storing a set of code to a variable to be reused later.
